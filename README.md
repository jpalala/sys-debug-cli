...
+-------------------------------------------------------------+
|                        .env File                            |
|  (APP_ENV, LOG_LEVEL, API_BASE_URL, TIMEOUT_SECS)            |
+------------------------------+------------------------------+
|
v
+-------------------------------------------------------------+
|                    Context Factory                          |
|  Initializes: Settings (Pydantic)                           |
...
+-------------------------------------------------------------+
|                       Shared Context                        |
|  Passed globally to all commands down the line              |
+------------------+-----------------------+------------------+
|                       |
v                       v
+-------------------+   +-------------------+
|  status Command   |   |  deploy Command   |
+-------------------+   +-------------------+
...
[file-tag: code-generated-file-0-1779207899277822135]

Here is the full structured text of the `README.md` file for your preview:
